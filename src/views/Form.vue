<template>
  <div class="form-wrapper">
    ...
    <v-form v-else v-model="valid">
      <v-text-field label="Name" required :rules="nameRules" v-model="name" validate-on-blur></v-text-field>
      <v-text-field label="Email" required :rules="emailRules" v-model="email" validate-on-blur></v-text-field>
      <v-text-field
        label="Phone"
        required
        :rules="phoneRules"
